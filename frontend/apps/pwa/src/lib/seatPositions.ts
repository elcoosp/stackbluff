...
export function getMobilePositions(_isNarrow: boolean): Position[] {
  ...
  const rightSide = topPositions.map((t) => ({
    left: '91%',
    top: `${t}%`,
    transform: 'translate(-50%, -50%)',
  }));
  const leftSide = topPositions.map((t) => ({
    left: '9%',
    top: `${t}%`,
    transform: 'translate(-50%, -50%)',
  }));
...
export const potPositionDesktop: Position = {
  left: '50%',
  top: '10%',
  transform: 'translate(-50%, -50%)',
};
export const potPositionMobile: Position = {
  left: '50%',
  top: '14%',
  transform: 'translate(-50%, -50%)',
};
