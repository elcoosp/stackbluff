...
export function useGameHandCompletion() {
  ...
  useEffect(() => {
    ...
    const currentRoomId: string = (activeRoom const currentRoomId = (activeRoom && typeof activeRoom === "object" && "roomId" in activeRoom && activeRoom.roomId) ? String(activeRoom.roomId) : (activeRoom && typeof activeRoom === "object" && "id" in activeRoom && activeRoom.id) ? String(activeRoom.id) : "unknown";const currentRoomId = (activeRoom && typeof activeRoom === "object" && "roomId" in activeRoom && activeRoom.roomId) ? String(activeRoom.roomId) : (activeRoom && typeof activeRoom === "object" && "id" in activeRoom && activeRoom.id) ? String(activeRoom.id) : "unknown"; typeof activeRoom === "object" const currentRoomId = (activeRoom && typeof activeRoom === "object" && "roomId" in activeRoom && activeRoom.roomId) ? String(activeRoom.roomId) : (activeRoom && typeof activeRoom === "object" && "id" in activeRoom && activeRoom.id) ? String(activeRoom.id) : "unknown";const currentRoomId = (activeRoom && typeof activeRoom === "object" && "roomId" in activeRoom && activeRoom.roomId) ? String(activeRoom.roomId) : (activeRoom && typeof activeRoom === "object" && "id" in activeRoom && activeRoom.id) ? String(activeRoom.id) : "unknown"; "roomId" in activeRoom const currentRoomId = (activeRoom && typeof activeRoom === "object" && "roomId" in activeRoom && activeRoom.roomId) ? String(activeRoom.roomId) : (activeRoom && typeof activeRoom === "object" && "id" in activeRoom && activeRoom.id) ? String(activeRoom.id) : "unknown";const currentRoomId = (activeRoom && typeof activeRoom === "object" && "roomId" in activeRoom && activeRoom.roomId) ? String(activeRoom.roomId) : (activeRoom && typeof activeRoom === "object" && "id" in activeRoom && activeRoom.id) ? String(activeRoom.id) : "unknown"; activeRoom.roomId) ? String(activeRoom.roomId) : (activeRoom const currentRoomId = (activeRoom && typeof activeRoom === "object" && "roomId" in activeRoom && activeRoom.roomId) ? String(activeRoom.roomId) : (activeRoom && typeof activeRoom === "object" && "id" in activeRoom && activeRoom.id) ? String(activeRoom.id) : "unknown";const currentRoomId = (activeRoom && typeof activeRoom === "object" && "roomId" in activeRoom && activeRoom.roomId) ? String(activeRoom.roomId) : (activeRoom && typeof activeRoom === "object" && "id" in activeRoom && activeRoom.id) ? String(activeRoom.id) : "unknown"; typeof activeRoom === "object" const currentRoomId = (activeRoom && typeof activeRoom === "object" && "roomId" in activeRoom && activeRoom.roomId) ? String(activeRoom.roomId) : (activeRoom && typeof activeRoom === "object" && "id" in activeRoom && activeRoom.id) ? String(activeRoom.id) : "unknown";const currentRoomId = (activeRoom && typeof activeRoom === "object" && "roomId" in activeRoom && activeRoom.roomId) ? String(activeRoom.roomId) : (activeRoom && typeof activeRoom === "object" && "id" in activeRoom && activeRoom.id) ? String(activeRoom.id) : "unknown"; "id" in activeRoom const currentRoomId = (activeRoom && typeof activeRoom === "object" && "roomId" in activeRoom && activeRoom.roomId) ? String(activeRoom.roomId) : (activeRoom && typeof activeRoom === "object" && "id" in activeRoom && activeRoom.id) ? String(activeRoom.id) : "unknown";const currentRoomId = (activeRoom && typeof activeRoom === "object" && "roomId" in activeRoom && activeRoom.roomId) ? String(activeRoom.roomId) : (activeRoom && typeof activeRoom === "object" && "id" in activeRoom && activeRoom.id) ? String(activeRoom.id) : "unknown"; activeRoom.id) ? String(activeRoom.id) : "unknown";
