          ...
          {isTelegramUser ? (
            <div className="flex items-center gap-3 p-3 bg-tertiary/10 border border-tertiary/20 rounded-lg">
              ...
              <div>
                <p className="text-sm text-on-surface font-medium">
                  <Trans>Signed in with Telegram</Trans>
                </p>
                <p className="text-xs text-on-surface-variant">
                  <Trans>Your account is linked to Telegram.</Trans>
                </p>
              </div>
            </div>
          ) : (
            <div className="space-y-3">
              <p className="text-sm text-on-surface-variant">
                <Trans>
                  Link your Telegram account to receive notifications, tournament reminders, and
                  more.
                </Trans>
              </p>
              <Button
              ...
              <p className="text-xs text-on-surface-variant/50">
                <Trans>
                  You will be redirected to Telegram. Follow the instructions in the bot to complete
                  linking.
                </Trans>
              </p>
            </div>
