    ...
    <div className="max-w-3xl mx-auto p-6 space-y-6">
        ...
        <CardContent>
          <p className="text-sm text-on-surface-variant">
            <Trans>
              ...
              payment information. We also collect usage data, device information, and cookies for
      ...
      <Card>
        ...
        <CardContent>
          <ul className="text-sm text-on-surface-variant list-disc pl-5 space-y-1">
            <li>
              <Trans>To provide, maintain, and improve the Service</Trans>
            </li>
            <li>
              <Trans>To process transactions and send related information</Trans>
            </li>
            <li>
              <Trans>To communicate with you about updates, promotions, and support</Trans>
            </li>
            <li>
              <Trans>To prevent fraud and ensure security</Trans>
            </li>
          </ul>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <p className="text-sm text-on-surface-variant">
            <Trans>
              ...
              Service. You may request deletion of your data at any time via the Privacy settings.
            </Trans>
          </p>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <p className="text-sm text-on-surface-variant">
            <Trans>
              ...
              for fraud prevention. You can manage your cookie preferences in your browser settings.
            </Trans>
          </p>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <p className="text-sm text-on-surface-variant">
            <Trans>
              ...
              necessary to provide the Service (e.g., payment processors, hosting providers) or as
              required by law.
            </Trans>
          </p>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <ul className="text-sm text-on-surface-variant list-disc pl-5 space-y-1">
            <li>
              <Trans>Access, correct, or delete your data</Trans>
            </li>
            <li>
              <Trans>Withdraw consent for data processing</Trans>
            </li>
            <li>
              <Trans>Data portability</Trans>
            </li>
            <li>
              <Trans>Opt out of marketing communications</Trans>
            </li>
          </ul>
