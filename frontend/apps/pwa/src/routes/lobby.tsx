...
function LobbyPage() {
  ...
  if (isLoading) {
    return (
      <div className="flex justify-center p-8 text-on-surface">
  ...
  if (error) {
    return (
      <div className="text-error p-8 text-center">
        <Trans>Error: {(error as Error).message}</Trans>
      </div>
    );
  }
            ...
            {sortedTables.map((table) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute inset-0 w-full h-full z-0 transition-all duration-500 bg-gradient-to-r from-[#0a0a0c]/85 via-[#0a0a0c]/50 to-[#0a0a0c]/85 group-hover:from-[#0a0a0c]/75 group-hover:via-[#0a0a0c]/35 group-hover:to-[#0a0a0c]/75" />
                  ...
                  <div className="w-full lg:col-span-4 flex items-start lg:items-center gap-3 lg:gap-4 relative z-10">
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="font-headline-md text-base text-on-surface truncate">
                        {table.name}
                      </h4>
                      <p className="text-[10px] text-outline font-label-caps mt-0.5">
                        <Trans>NO LIMIT HOLD&apos;EM</Trans>
                      </p>
