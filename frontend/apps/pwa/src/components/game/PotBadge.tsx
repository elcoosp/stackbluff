            ...
            >
              ...
              <div className="flex items-center justify-center gap-1 text-center">
                ...
                <span
                  ...
                  style={{
                    backgroundImage:
                      'linear-gradient(90deg, #4edea3 0%, #6ffbbe 30%, #0cb880 60%, #4edea3 100%)',
                    backgroundSize: '200% 100%',
                    animation: 'shimmer 5s infinite linear',
                  }}
                >
                  {isMobile ? '' : <Trans>POT </Trans>}${formatAmount(Math.round(animatedAmount))}
                </span>
              </div>
              ...
              <motion.div
                ...
                initial={false}
                animate={{
                  width: toCall && toCall > 0 ? 'auto' : 0,
                  opacity: toCall && toCall > 0 ? 1 : 0,
                }}
              ...
              >
                <span className="text-white/15">|</span>
                <Target
                  className={cn('text-tertiary/50', isMobile ? 'w-2.5 h-2.5' : 'w-2.5 h-2.5')}
                />
