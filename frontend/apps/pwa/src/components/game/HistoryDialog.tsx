...
// Works with both short ("As") and full ("AceClubs") formats.
// Uses the same mappings as the rest of your app.
...
function parseCard(cardStr: string): { rank: string; suit: string } {
  // 1) Short format: last char is suit letter
  ...
  // 2) Full format: CamelCase like "AceClubs"
      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed z-[810] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[calc(100%-2rem)] max-w-md rounded-xl bg-[rgba(12,12,12,0.97)] border border-white/10 backdrop-blur-xl shadow-2xl overflow-hidden flex flex-col max-h-[80vh]"
          >
            {/* Header */}
