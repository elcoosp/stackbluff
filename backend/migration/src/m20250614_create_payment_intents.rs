        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(ColumnDef::new(PaymentIntents::Id).uuid().not_null().primary_key())
                    .col(ColumnDef::new(PaymentIntents::PaymentId).string().not_null())
                    .col(ColumnDef::new(PaymentIntents::UserId).uuid().not_null())
                    .col(ColumnDef::new(PaymentIntents::Amount).big_integer().not_null())
                    ...
                    .col(ColumnDef::new(PaymentIntents::Metadata).json_binary().not_null())
                    .index(Index::create().name("idx_payment_intents_payment_id").col(PaymentIntents::PaymentId).unique())
                    .index(Index::create().name("idx_payment_intents_user_status").col(PaymentIntents::UserId).col(PaymentIntents::Status))
                    .to_owned(),
            )
            .await
    }
