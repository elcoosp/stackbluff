...
impl MigrationTrait for Migration {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Referral::ReferredId)
                            .string()
                            .not_null()
                            .unique_key(),
                    )
                    .col(
                        ColumnDef::new(Referral::HandCount)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    .col(
                        ColumnDef::new(Referral::BonusAwarded)
                            .boolean()
                            .not_null()
                            .default(false),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(SystemCounter::Id)
                            .integer()
                            .not_null()
                            .auto_increment()
                            .primary_key(),
                    ...
                    .col(
                        ColumnDef::new(SystemCounter::Name)
                            .string()
                            .not_null()
                            .unique_key(),
                    )
                    .col(
                        ColumnDef::new(SystemCounter::Value)
                            .big_integer()
                            .not_null()
                            .default(0),
                    )
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            ...
            .await?;
        manager
            .drop_table(Table::drop().table(SystemCounter::Table).to_owned())
            .await?;
        Ok(())
    }
}
