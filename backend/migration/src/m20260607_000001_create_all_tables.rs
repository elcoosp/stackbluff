...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .get_connection()
            .execute_unprepared(
                "ALTER TABLE users ADD CONSTRAINT chip_balance_nonneg CHECK (chip_balance >= 0)",
            )
            .await?;
                ...
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(player_rank::Column::RankTier)
                            .enumeration(RankTier::name(), RankTier::iter().map(|v| v.to_value()))
                            .not_null(),
                    )
                    .col(
                ...
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(table::Column::Status)
                            .enumeration(
                                TableStatus::name(),
                                TableStatus::iter().map(|v| v.to_value()),
                            )
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(subscription_event::Column::EventType)
                            .enumeration(
                                ...
                                SubscriptionEventType::iter().map(|v| v.to_value()),
                            )
                            .not_null(),
                    )
                    .col(
